...
export default function Shirt(props) {
    return (
        <div className="shirt-container">
            ...
            <div onClick={() => props.changeShirt(<img className='shirt_image' src={Shirt3} alt='shirt' />, <img className='back_shirt_image'  src={backShirt2} alt='shirt' />)}>
                <img className='shirt-side' src={Shirt3} alt='shirt' />
                <p className='tooltiptext'><strong>Plain <br />placket</strong></p>
            </div>
            <div onClick={() => props.changeShirt(<img className='shirt_image' src={Shirt4} alt='shirt' />, <img className='back_shirt_image'  src={backShirt2} alt='shirt' />)}>
                <img className='shirt-side' src={Shirt4} alt='shirt' />
                <p className='tooltiptext'><strong>Plain <br />placket</strong></p>
            </div>
            <div onClick={() => props.changeShirt(<img className='shirt_image' src={Shirt5} alt='shirt' />, <img className='back_shirt_image'  src={backShirt2} alt='shirt' />)}>
